...
<ul class="navbar-nav " >
      <li class="nav-item active " >
        <a class="nav-link" href="${pageContext.request.contextPath}/views/organization-add.jsp">Organization</a>
      </li>
      <li class="nav-item  ">
        <a class="nav-link" href="${pageContext.request.contextPath}/views/user-add.jsp">User</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="${pageContext.request.contextPath}/views/directorates-add.jsp">Directorates</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="#">Reports</a>
      </li>
       <li class="nav-item ">
        <a class="nav-link" href="${pageContext.request.contextPath}/views/penalty-rule.jsp">Penalty</a>
      </li>
      <li class="nav-item ">
